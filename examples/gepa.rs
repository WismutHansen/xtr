...
/// To run:
/// ```
/// OPENAI_API_KEY=your_key cargo run gepa
/// ```
use anyhow::Result;
use bon::Builder;
use dspy_rs::*;
...
struct TranslationJudge {
    ...
    #[input(desc = "The input sentence that was given")]
    pub input_text: String,

    #[input(desc = "The language of the given input")]
    pub input_language: String,

    #[input(desc = "The expected output language of the translated sentence")]
    pub output_language: String,

    #[input(desc = "The expected reference translation")]
...
impl FeedbackEvaluator for Translator {
...
async fn main() -> Result<()> {
    ...
    // Create the module
    let mut module = Translator::builder()
        .solver(Predict::new(MathWordProblem::new()))
        .judge(Predict::new(TranslationJudge::new()))
